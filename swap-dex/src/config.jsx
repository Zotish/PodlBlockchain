...
export const NODE_URL = normalizeBaseUrl(
	import.meta.env.REACT_APP_API_BASE || import.meta.env.REACT_APP_NODE_URL || import.meta.env.VITE_API_BASE || import.meta.env.VITE_NODE_URL,
  "https://api.178-105-133-94.sslip.io"
); // aggregator (or 5000 for single node)

export const WALLET_URL = normalizeBaseUrl(
	import.meta.env.REACT_APP_WALLET_BASE || import.meta.env.REACT_APP_WALLET_URL || import.meta.env.VITE_WALLET_BASE || import.meta.env.VITE_WALLET_URL,
  "https://wallet.178-105-133-94.sslip.io"
); // wallet server

export const WEB_WALLET_URL = normalizeBaseUrl(
	import.meta.env.REACT_APP_WEB_WALLET_URL || import.meta.env.VITE_WEB_WALLET_URL,
  "http://127.0.0.1:3000"
...
export const DEX_CONTRACT_ADDRESS =
	(import.meta.env.REACT_APP_DEX_CONTRACT_ADDRESS || import.meta.env.VITE_DEX_CONTRACT_ADDRESS || "0x51d85e8fea15bc1523e83f9fc919c11605abc4ae").trim(); // deployed Factory contract

export const DEX_ROUTER_ADDRESS =
	(import.meta.env.REACT_APP_DEX_ROUTER_ADDRESS || import.meta.env.VITE_DEX_ROUTER_ADDRESS || "").trim(); // optional Router contract initialized with factory address
