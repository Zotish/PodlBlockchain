...
const (
	MaxBlockGas             = 8000000 // Maximum gas per block
...
type Validator struct {
	...
	PenaltyScore   float64   `json:"penalty_score"`   // Track validator misbehavior
	BlocksProposed int       `json:"blocks_proposed"` // Track validator activity
	BlocksIncluded int       `json:"blocks_included"` // Track successful blocks
	LastActive     time.Time `json:"last_active"`     // Track last activity
}
